...
import fr.triedge.worker.ui.Browser;
...
public class Controller extends Application{
	...
	public void start(Stage stage) throws Exception {
		...
		String icon = Utils.config.getProperty("fx.icon", "/icon_bright.png");
		...
		getMainWindow().getItemBrowserNavigate().setOnAction(e -> actionBrowserNavigate(e));
	...
	public void actionBrowserNavigate(ActionEvent e) {
		Browser b = new Browser();
		b.buildUI();
		openTab("Browser", b);
	}

	public void actionOpenTaskManager() {
		TaskManager man = new TaskManager(this);
		openTab("Task Manager", man);
	}
	
	public void actionOnpenNewURL(String url) {
		Browser b = new Browser();
		b.buildUI();
		b.navigate(url);
		openTab(url, b);
	...
	public void actionChangeStorage(ActionEvent e) {
	...
	public void actionNewNote(ActionEvent e) {
	...
	public void actionOpenNote(ActionEvent e) {
